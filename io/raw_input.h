...
#include <stddef.h>
void get_meta(const char *filename, size_t *max_sequence_length, size_t *sequence_count, size_t *char_count);
void get_meta_kseq(const char *filename, size_t *max_sequence_length, size_t *sequence_count, size_t *char_count);
